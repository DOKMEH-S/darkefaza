...
$('header .menu-language-wrap .language-box a').addClass('menuItem');
/*====================DETECT TIME=====================*/
...
if(direction === 'rtl'){
    let splitTitleee = new SplitText($('section.home-slogan-container .slogan-info h1'),{type: "lines", linesClass:'line mBox', position: "relative" });
    let splitDateee = new SplitText($('main.homeWrapper section.home-slogan-container .slogan-info p'),{type: "lines", linesClass:'line mBox', position: "relative" });
    let splitContenttt = new SplitText($('main.homeWrapper section.home-about-container .content'),{type: "lines",linesClass:'line mBox', position: "relative" });
...
function ajaxSucses(){
    switch (pageTag){
        ...
        function loadTextScramble(){
            let phrases = [];
            if (direction === 'rtl'){
                phrases = ['من یک دستیار هوشمند هستم']
            } else if (direction !== 'rtl'){
                phrases = ['I am a very smart assist here for you'];
            }
        ...
        function showProjectName(){
            $('section.projectsContainer .grid-item .projectWrap').on('mouseover',function () {
                let element = $(this),
                    ...
                    finalCorXRTl = elementLeft - currentWidth,
            ...
            $('section.projectsContainer').mouseleave(function () {
                ...
                let phrasessss = [];
                if(direction === 'rtl'){
                    phrasessss = ['من یک دستیار هوشمند هستم'];
                } else if(direction !== 'rtl'){
                    phrasessss = ['I am a very smart assist here for you'];
                }
                ...
                let widthWindow = $(document).width(),
                    paddingHeader = parseInt($('header.projectHeader .identity-text-title-wrap').css('padding-right')),
                    paddingTotal = widthWindow - paddingHeader ;
                projectName.css({
                    'left':'0',
                    'top':'0'
                })
